...
The example will be to fit an environmentally-mediated stock-recruitment relationship (EMSRR), using a modified Ricker [e.g. "controlling"-type as described by @levi_embedding_2003]:
