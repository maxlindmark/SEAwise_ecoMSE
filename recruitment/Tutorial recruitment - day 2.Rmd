...
## Introduction
To test the significance of environmental variables on recruitment process, first we need to select meaningful covariates. The environmental time series used in this tutorial have been derived from Copernicus (https://www.copernicus.eu/en). 
