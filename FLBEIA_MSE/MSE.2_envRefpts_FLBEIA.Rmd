...
[plyr](https://cran.r-project.org/web/packages/plyr), [stringr](https://cran.r-project.org/web/packages/stringr/), [reshape2](https://cran.r-project.org/web/packages/reshape2/), [ggplot2](https://cran.r-project.org/web/packages/ggplot2/), [ggdark](https://cran.r-project.org/web/packages/ggdark/), [patchwork](https://cran.r-project.org/web/packages/patchwork/)
...
install.packages( c("plyr","stringr","reshape2",
